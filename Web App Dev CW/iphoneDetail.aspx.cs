...
{
    public partial class iphoneDetail : System.Web.UI.Page
    {
        ...
        private void LoadProducts()
        {
            ...
            {
                conn.Open();
                string query = "SELECT DISTINCT p.Name, p.ColourNumericID, p.ProductPicture, c.ColourName FROM Product p JOIN Colour c ON p.ColourNumericID = c.ColourNumericID WHERE p.Name IN ('iPhone 16 Pro', 'iPhone 16 Pro Max', 'iPhone 16', 'iPhone 16 Plus')";
