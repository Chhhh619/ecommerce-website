...
{
    public partial class macDetail : System.Web.UI.Page
    {
        ...
        private void LoadProducts()
        {
            ...
            {
                conn.Open();
                string query = "SELECT DISTINCT p.Name, p.ColourNumericID, p.ProductPicture, c.ColourName FROM Product p JOIN Colour c ON p.ColourNumericID = c.ColourNumericID WHERE p.Name IN ('MacBook Air', 'MacBook Pro')";
...
<div class='containershop5'>
            ...
            <a  class='buybutton' href='buyMac.aspx'>
Buy
</a>
