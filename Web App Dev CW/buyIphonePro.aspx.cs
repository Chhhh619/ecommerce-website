...
{
    public partial class buyIphonePro : System.Web.UI.Page
    {
        ...
        {
            string model = ddlModelPro.SelectedValue;
            string colour = ddlColorPro.SelectedValue;
            string capacity = ddlStoragePro.SelectedValue;
        ...
        protected void ddlModelPro_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        protected void ddlColorPro_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        protected void ddlStoragePro_SelectedIndexChanged(object sender, EventArgs e)
        {
